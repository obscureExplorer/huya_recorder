...
function startRecord(roomId, retryCount) {
    proc = spawn("java", ["-Dfile.encoding=utf-8", "-jar", "BiliLiveRecorder.jar", "debug=false&check=false&delete=false&liver=huya&id=" + roomId + "&retry=3&qn=-1&qnPri=钃濆厜4M>瓒呮竻>楂樻竻>娴佺晠"], { cwd: '/home/ubuntu' })
